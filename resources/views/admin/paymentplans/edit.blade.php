...
@section('title', 'Edit Payment Plan :: '.$plan->name)
@section('adminlayout')
            ...
            <div class="card ">
                <div class="card-header pb-0 p-3">
                    <div class="d-flex justify-content-between">
                        ...
                        <h2 class="mb-2">Edit Payment Plan</h2>
                ...
                <div class="card-body">
                    <form role="form" method="POST" action="{{ route('payment.update', $plan->id) }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <input type="text" class="form-control form-control-lg @error('amount') is-invalid @enderror" placeholder="Amount"
                                        name="amount" aria-label="text" value="{{ $plan->amount }}">
                                    @error('amount')
                                    <div class="text text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <input type="text" class="form-control form-control-lg @error('duration_in_name') is-invalid @enderror" placeholder="Duration In Name"
                                        name="duration_in_name" aria-label="text" value="{{ $plan->duration_in_name }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <input type="text" class="form-control form-control-lg @error('duration_in_number') is-invalid @enderror" placeholder="Duration In Number"
                                        name="duration_in_number" aria-label="text" value="{{ $plan->duration_in_number }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <input {{ $plan->status ? "checked" : "" }} @error('status') is-invalid @enderror type="checkbox" name="status" id="status"> <label for="status">Status</label>
                                    @error('status')
                                    <div class="text text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
